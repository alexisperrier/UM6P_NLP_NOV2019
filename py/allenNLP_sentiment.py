'''
Sentiment analyzer AllenNLP
http://www.realworldnlpbook.com/ch2.html#sst-nb
'''
...
# check that the dataset has been loaded into the reader instances
!head -n 2 '/home/alexis/NLP/data/trees/dev.txt'
for inst in dev_dataset[:2]: print(inst)
...
encoder = PytorchSeq2VecWrapper(
    torch.nn.LSTM(128,HIDDEN_DIM, batch_first = True)
)
